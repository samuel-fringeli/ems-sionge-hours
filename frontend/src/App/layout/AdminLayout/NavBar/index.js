        ...
        let navBar = (
            <Aux>
                <div className="m-header">
                    ...
                    <div className="cursor-with-pointer b-brand" onClick={() => this.props.history.push('/workdays')}>
...
export default compose(withRouter, connect(mapStateToProps, mapDispatchToProps))(windowSize(NavBar));
