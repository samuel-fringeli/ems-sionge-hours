...
class NavSearch extends Component {
    ...
    render() {
        ...
        return (
            <Aux>
                <a href={DEMO.BLANK_LINK} className="pop-search d-none" onClick={() => this.setState(prevState => {return {isSearch: !prevState.isSearch}})}><i className="feather icon-search"/></a>
