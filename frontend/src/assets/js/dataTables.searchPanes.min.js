...
-1;if(l&&l.searchPanes&&l.searchPanes.panes)for(var p=0;p<l.searchPanes.panes.length;p++)if(l.searchPanes.panes[p].id===this.s.index){q=p;break}if((!1===c.show||void 0!==c.show&&!0!==c.show)&&-1===q)return this.dom.container.addClass(this.classes.hidden),this.s.displayed=!1;if(!0===c.show||-1!==q)this.s.displayed=!0;if(0===e.arrayFilter.length)if(this._populatePane(),l&&l.searchPanes&&l.searchPanes.panes)if(-1!==q)e.binsOriginal=l.searchPanes.panes[q].bins,e.arrayOriginal=l.searchPanes.panes[q].arrayFilter; // eslint-disable-line
else{this.dom.container.addClass(this.classes.hidden);this.s.displayed=!1;return}else e.arrayOriginal=e.arrayFilter,e.binsOriginal=e.bins;p=Object.keys(e.binsOriginal).length;q=this._uniqueRatio(p,d.rows()[0].length);if(!1===this.s.displayed&&((void 0===c.show&&null===c.threshold?q>this.c.threshold:q>c.threshold)||!0!==c.show&&1>=p)){this.dom.container.addClass(this.classes.hidden);this.s.displayed=!1;return}this.c.viewTotal&&0===e.arrayTotals.length?this._detailsPane():e.binsTotal=e.bins;this.dom.container.addClass(this.classes.show)}this.s.displayed= // eslint-disable-line
...
d){for(var g=[],c=0;c<d.length;c++){var e=d[c];-1===g.indexOf(e.filter)&&(a.push({display:e.display,filter:e.filter,sort:e.sort,type:e.type}),g.push(e.filter))}};f.prototype._getBonusOptions=function(){return $.extend(!0,{},f.defaults,{orthogonal:{threshold:null},threshold:null},void 0!==this.c?this.c:{})};f.prototype._getComparisonRows=function(){var a=this.s.colOpts;a=void 0!==a.options?a.options:null!==this.customPaneSettings&&void 0!==this.customPaneSettings.options?this.customPaneSettings.options: // eslint-disable-line
void 0;if(void 0!==a){var d=this.s.dt.rows({search:"applied"}).data().toArray(),g=this.s.dt.rows({search:"applied"}),c=this.s.dt.rows().data().toArray(),e=this.s.dt.rows(),b=[];this.s.dtPane.clear();for(var f=0;f<a.length;f++){var l=a[f],q=""!==l.label?l.label:this.c.emptyMessage,k=q,h="function"===typeof l.value?l.value:[],m=0,v=q,u=0;if("function"===typeof l.value){for(var t=0;t<d.length;t++)l.value.call(this.s.dt,d[t],g[0][t])&&m++;for(t=0;t<c.length;t++)l.value.call(this.s.dt,c[t],e[0][t])&&u++; // eslint-disable-line
"function"!==typeof h&&h.push(l.filter)}(!this.c.cascadePanes||this.c.cascadePanes&&0!==m)&&b.push(this._addRow(k,h,m,u,v,q))}return b}};f.prototype._getOptions=function(){return $.extend(!0,{},f.defaults,{orthogonal:{threshold:null},threshold:null},this.s.dt.settings()[0].aoColumns[this.s.index].searchPanes)};f.prototype._makeSelection=function(){this.updateTable();this.s.updating=!0;this.s.dt.draw();this.s.updating=!1};f.prototype._populatePane=function(){var a=this.s.dt;this.s.rowData.arrayFilter= // eslint-disable-line
[];this.s.rowData.bins={};var d=this.s.dt.settings()[0],g=0;for(a=!this.c.cascadePanes&&!this.c.viewTotal||this.s.clearing?a.rows().indexes():a.rows({search:"applied"}).indexes();g<a.length;g++)this._populatePaneArray(a[g],this.s.rowData.arrayFilter,d)};f.prototype._populatePaneArray=function(a,d,g,c){void 0===c&&(c=this.s.rowData.bins);var e=this.s.colOpts;if("string"===typeof e.orthogonal)g=g.oApi._fnGetCellData(g,a,this.s.index,e.orthogonal),this.s.rowData.filterMap.set(a,g),this._addOption(g, // eslint-disable-line
g,g,g,d,c);else{var b=g.oApi._fnGetCellData(g,a,this.s.index,e.orthogonal.search);this.s.rowData.filterMap.set(a,b);c[b]?c[b]++:(c[b]=1,this._addOption(b,g.oApi._fnGetCellData(g,a,this.s.index,e.orthogonal.display),g.oApi._fnGetCellData(g,a,this.s.index,e.orthogonal.sort),g.oApi._fnGetCellData(g,a,this.s.index,e.orthogonal.type),d,c))}};f.prototype._reloadSelect=function(a){if(void 0!==a){for(var d,g=0;g<a.searchPanes.panes.length;g++)if(a.searchPanes.panes[g].id===this.s.index){d=g;break}if(void 0!== // eslint-disable-line
...
c&&(a.select(),g.splice(c,1))},f=0,l=this._getComparisonRows();f<l.length;f++)d=l[f],e(d);for(e=0;e<g.length;e++)d=g[e],d=this._addRow(d.display,d.filter,0,this.c.viewTotal?d.total:0,d.filter,d.filter),d.select();this.s.dtPane.draw();this.s.dtPane.table().node().parentNode.scrollTop=a}};f.version="1.0.1";f.classes={buttonGroup:"dtsp-buttonGroup",buttonSub:"dtsp-buttonSub",clear:"dtsp-clear",clearAll:"dtsp-clearAll",clearButton:"clearButton",container:"dtsp-searchPane",countButton:"dtsp-countButton", // eslint-disable-line
disabledButton:"dtsp-disabledButton",dull:"dtsp-dull",hidden:"dtsp-hidden",hide:"dtsp-hide",layout:"dtsp-",name:"dtsp-name",nameButton:"dtsp-nameButton",narrow:"dtsp-narrow",paneButton:"dtsp-paneButton",paneInputButton:"dtsp-paneInputButton",pill:"dtsp-pill",search:"dtsp-search",searchCont:"dtsp-searchCont",searchIcon:"dtsp-searchIcon",searchLabelCont:"dtsp-searchButtonCont",selected:"dtsp-selected",smallGap:"dtsp-smallGap",subRow1:"dtsp-subRow1",subRow2:"dtsp-subRow2",subRowsContainer:"dtsp-subRowsContainer", // eslint-disable-line
